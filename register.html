...
<body>
    ...
    <header>
        <ul class="nav justify-content-end first-navbar">
          <li class="nav-item">
            <a class="nav-link nav-level1" href="login.html">Login</a>
          </li>
          <li class="nav-item">
            <a class="nav-link nav-level1" href="register.html">Sign Up</a>
          </li>
        </ul>
                    ...
                    <div class="col-md-6 mx-auto">
                        <div class="card border-dark">
                            <div class="card-header">
                                <h3 class="mb-0 my-2">Sign Up Form</h3>
                            </div>
                            <div class="card-body">
                                <form class="form" role="form" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="inputEmail3" placeholder="email@mail.com" required="">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-dark btn-md float-right">Register</button>
                                    </div>
                                </form>
                                <a href="login.html" class="float-left"> Have account? Click here to login </a>
                            </div>
                        </div>
                    </div>
                </div>
